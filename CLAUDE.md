...
**YOU ARE IN: `cmau/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/cmau/` (rig root) or other directories
...
**Your mail address:** `cmau/polecats/rust`
**Your rig:** cmau
**Your Witness:** `cmau/witness`
...
| Ask Witness for help | `gt mail send cmau/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`cmau/witness`) when:
...
```bash
gt mail send cmau/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
